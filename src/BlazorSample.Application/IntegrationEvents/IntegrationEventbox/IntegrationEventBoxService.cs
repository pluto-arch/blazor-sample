...
namespace BlazorSample.Application.IntegrationEvents.IntegrationEventbox;
...
public class IntegrationEventBoxService
{
    ...
    public IntegrationEventBoxService(IUnitOfWork<BlazorSampleDbContext> uow, ILogger<IntegrationEventBoxService> logger)
    {
        _uow = uow;
        _logger = logger;
    }
