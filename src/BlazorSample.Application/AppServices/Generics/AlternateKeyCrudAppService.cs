...
namespace BlazorSample.Application.AppServices.Generics
{
    ...
    where TGetListRequest : PageRequest
    {
        ...
        protected AlternateKeyCrudAppService(IUnitOfWork<BlazorSampleDbContext> uow, IMapper mapper)
        {
